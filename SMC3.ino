...
const int ENApin1 =26;          // ENA output pin for Motor H-Bridge 1 (ie PortD bit position) 
const int ENBpin1 =27;          // ENB output pin for Motor H-Bridge 1 (ie PortD bit position)
...
const int PWMpin1 =22;          // PWM output pin for Motor 1   
const int PWMpin2 =23;         // PWM output pin for Motor 2    
const int PWMpin3 =24;         // PWM output pin for Motor 3 
